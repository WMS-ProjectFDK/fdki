...
<body leftmargin="0" topmargin="0">
	<div style="width:100%;position:absolute;background:#272727;border-bottom:2px solid #ED1C24;">
		<div style="float:left;background:url('images/logo-fdk-1.png') no-repeat;width:40%;height:90px;background-size:50% 100%;display:none;" id="logo">
			<div style="width:25px;background:#272727;height:100%;opacity:0.3;filter:alpha(opacity=30);display:none;" id="splash"></div>
		</div>
