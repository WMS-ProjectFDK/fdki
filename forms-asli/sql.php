	      ...
	      <div class="starter-template">
	        ...
	        <form method="post" target="<?php $_SERVER['PHP_SELF'];?>">
			    <div class="form-group">	
					  <textarea type="text" rows="4" cols="140" name="qry" id="qry" autofocus="autofocus"></textarea>
					  <p><button type="submit" name="submit" class="btn btn-primary">Process</button></p>
				</div>
			</form>
	      </div>
	      <div class="container">
