...
<body>
	...
	<table id="dg" title="PURCHASE REQUESTION APPROVAL" toolbar="#toolbar" class="easyui-datagrid" rownumbers="true" fitColumns="true" style="width:100%;height:490px;"></table>
