...
if (isset($_SESSION['id_wms'])){
	...
	$sql_equ = "update ztb_menu set menu_name='$nama_menu', link='$link', menu_parent = '$parent_name', id_parent = '$parent_id', id_menu = '$kode_menu',
		last_update = TO_DATE('".date('Y-m-d')."','yyyy-mm-dd'), update_by='$userentry' 
		where id=$menu_id";
