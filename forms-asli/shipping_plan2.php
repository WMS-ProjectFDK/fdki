...
<!-- START ADD -->
<div id='win_add' class="easyui-window" style="width:100%;height:auto;padding:5px 5px;" closed="true" closable="false" minimizable="false" maximizable="true" collapsible="false" data-options="modal:true">
	<form id="f_add" method="post" novalidate>
		<fieldset style="border:1px solid #d0d0d0; border-radius:2px; width:98%; float:left; margin:5px;">
			...
			<div class="fitem">
				...
				<input style="width:637px;" name="vessel_add" id="vessel_add" class="easyui-textbox"/>
			</div>
			<div class="fitem">
				...
				<input style="width:637px;" name="remark_add" id="remark_add" class="easyui-textbox"/>
			</div>
		</fieldset>
...
<!-- START EDIT -->
<div id='win_edit' class="easyui-window" style="width:100%;height:auto;padding:5px 5px;" closed="true" closable="false" minimizable="false" maximizable="true" collapsible="false" data-options="modal:true">
	<form id="f_edit" method="post" novalidate>
		<fieldset style="border:1px solid #d0d0d0; border-radius:2px; width:98%; float:left; margin:5px;">
			...
			<div class="fitem">
				...
				<span style="width:70px;display:inline-block;">VESSEL</span>
				<input style="width:637px;" name="vessel_edit" id="vessel_edit" class="easyui-textbox"/>
			</div>
			<div class="fitem">
				<span style="width:70px;display:inline-block;">SI No.</span>
				...
				<span style="width:240px;display:inline-block;"></span>
				<span style="width:70px;display:inline-block;">REMARK</span>
				<input style="width:637px;" name="remark_edit" id="remark_edit" class="easyui-textbox"/>
			</div>
		</fieldset>
		<div style="clear:both;margin-bottom:10px;"></div>
