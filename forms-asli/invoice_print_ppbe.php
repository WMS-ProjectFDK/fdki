...
while ($s <= $dt->CARGO_QTY1) {
	while ($data=oci_fetch_object($result)){
		...
		$content .= "
			<tr>
				<td valign='middle' align='center' style='font-size:9px;width:30px;height:13px;'>".$nourut."</td>
				<td valign='middle' align='left' style='font-size:9px;width:80px;height:13px;'>".$data->CUSTOMER_PO_NO."</td>
				<td valign='middle' align='center' style='font-size:9px;width:140px;height:13px;'>".$data->WORK_NO."</td>
				<td valign='middle' align='center' style='font-size:9px;width:50px;height:13px;'>".$data->ITEM_NO."</td>
				<td valign='middle' align='left' style='font-size:9px;width:200px;height:13px;'>".$data->ITEM."<br/>".$data->DESCRIPTION."</td>
				<td valign='middle' align='right' style='font-size:9px;width:70px;height:13px;'>".number_format($data->QTY)."&nbsp;</td>
				<td valign='middle' align='right' style='font-size:9px;width:70px;height:13px;'>".number_format($data->CASE_TOTAL)."&nbsp;</td>
				<td valign='middle' align='right' style='font-size:9px;width:70px;height:13px;'>".number_format($data->PALLET)."&nbsp;</td>
				<td valign='middle' align='right' style='font-size:9px;width:70px;height:13px;'>".number_format($data->FULL_PALLET)."&nbsp;</td>
				<td valign='middle' align='right' style='font-size:9px;width:70px;height:13px;'>".number_format($data->CTN_TERAKIR)."&nbsp;</td>
				<td valign='middle' align='right' style='font-size:9px;width:70px;height:13px;'>".number_format($data->BOX_PCS)."&nbsp;</td>
				<td valign='middle' align='center' style='font-size:9px;width:70px;height:13px;'>".$con_no."</td>
			</tr>";
