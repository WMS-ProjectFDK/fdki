...
<body>
	...
	<table id="dg" class="easyui-datagrid" style="width:100%;height:auto;"  url="progress_packing_result.json" rownumbers="false"  fitColumns="true" singleSelect="true">
	 	<thead>
			<tr>
				<th width="300" halign="center" align="left" field="WORK_ORDER"><b>WO NO.</b></th>
				<th width="250" halign="center" align="left" field="ITEM_NAME" data-options="styler:cellStyler3"><b>BRAND</b></th>
				<th width="100" halign="center" align="left" field="CR_DATE"><b>CR<br/>DATE</b></th>
				<th width="125" halign="center" align="right" field="QTY"><b>QTY</b></th>
				<th width="125" halign="center" align="right" field="LABEL_QTY" data-options="styler:cellStyler1"><b>LABEL<br/>(pcs)</b></th>
				<th width="125" halign="center" align="right" field="LABEL_GAP" data-options="styler:cellStyler1"><b>GAP LABEL<br/>(pcs)</b></th>
				<th width="170" halign="center" align="left" field="PACKAGING_TYPE"><b>PACKAGING<br/>GROUP</b></th>
				<th width="125" halign="center" align="right" field="PACK_QTY" data-options="styler:cellStyler2"><b>PACKING<br/>(pcs)</b></th>
				<th width="125" halign="center" align="right" field="PACK_GAP" data-options="styler:cellStyler2"><b>GAP PACK<br/>(pcs)</b></th>
	...
	<script type="text/javascript">
		...
		$(function(){
			var myData1 = setInterval(function(){procedure_proses()},5*60*1000);
			var myData2 = setInterval(function(){dg_reload()},1*60*1000);
