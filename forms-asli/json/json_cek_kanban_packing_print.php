...
$sql = "select wo_no,plt_no,tanggal,case when tanggal is null then 'BELUM DI PRINT' ELSE 'SUDAH DI PRINT' end sts from ztb_kanban_print_temp where wo_no='$wo_no' and user_name = '$user_name' group by wo_no,plt_no,tanggal";
