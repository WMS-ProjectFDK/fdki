...
<body class="easyui-layout">
	<div id="layout" 
		...
		<fieldset style="position: absolute; float: left;margin-left:5px;border-radius:4px;width: 43%;height: 530px;"><legend><span class="style3"><strong>INPUT LABEL TRANSAKSI</strong></span></legend>
			<div class="fitem" style="padding: 5px;" align="center">
				<span style="width:50%;display:inline-block;font-size: 18px;font-weight: bold;">SCAN KANBAN ASSEMBLING</span>
			</div>
			<div class="fitem" style="padding: 5px;" align="center">
			...
			<hr>
			<table id="dg_kupas" class="easyui-datagrid" toolbar="#toolbar_kupas" data-options="method: 'get', fitColumns: true, height: '58%', singleSelect: true">
		        <thead>
		            <tr>
		...
		<fieldset style="position:absolute;margin-left:46%;border-radius:4px;width: 49%;height: 530px;"><legend><span class="style3"><strong>LIST OF IN LABEL BATTERY</strong></span></legend>
