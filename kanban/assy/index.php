		...
		<div id="p" class="easyui-panel" title="ASSEMBLY KANBAN SYSTEM" data-options="tools:'#tt', footer:'#footer'"
			...
			<div id="toolbar_ng" style="width: 100%; float: left; padding: 10px;">
				...
				<div class="fitem">
					...
					<a href="javascript:void(0)" id="viewer" class="easyui-linkbutton c5" onclick="to_sparepart()" plain="true" style="width:320px; height:30px;font-weight: bold;"> SPAREPART ASSY MONITORING SYSTEM</a>
				</div>	
			</div>
		</div>
		<div id="tt">
