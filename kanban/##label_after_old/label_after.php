...
<body class="easyui-layout" >
	<div id="layout" 
				...
				<div class="fitem">
					<div class="fitem">
						...
						<div style="display: inline-block;float: right;">
							...
							<a id="savebtn_Plan" class="easyui-linkbutton c2" onClick="proses()" style="width:200px; height: 46px;display:inline-block;vertical-align: middle;"><i class="fa fa-save" aria-hidden="true"></i> LIST PENGERJAAN WO</a>
						</div>
		...
		<!--  -->
		<!-- <div id="dlg_list_in" class="easyui-dialog" style="width: 330px;height: auto;padding: 5px;" closed="true" buttons="#dlg-buttons-print-rec" data-options="modal:true">
