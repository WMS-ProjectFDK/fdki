...
if($fp = fsockopen($host,$port,$errCode,$errStr,$waitTimeoutInSeconds)){  ?>
   <meta http-equiv="Refresh" content="0; url=http://fdkindonesia:8088/kanban">
<?php }else { ?>
<!DOCTYPE html>
<head>
        ...
        <div class="col-md-8">
            ...
            <div class="account-wall">
                ...
                <form class="form-signin" method="get"><!-- method="post" -->
                    ...
                    <!-- <button class="btn btn-lg btn-danger btn-block" type="submit"><strong>LOGIN</strong></button> -->
